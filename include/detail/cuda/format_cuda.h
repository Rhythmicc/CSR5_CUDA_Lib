...
{
    int *d_scan;
    cudaMalloc((void **)&d_scan, ANONYMOUSLIB_CSR5_OMEGA * sizeof(int));
...
//    cudaMemcpy(check_partition_pointer, partition_pointer, (p+1) * sizeof(ANONYMOUSLIB_UIT), cudaMemcpyDeviceToHost);
                                  ...
                                  ANONYMOUSLIB_IT        *_num_offsets)
{
    ...
    cudaMemcpy(&num_offsets, &partition_descriptor_offset_pointer[p], sizeof(ANONYMOUSLIB_IT),   cudaMemcpyDeviceToHost);
...
//    cudaMemcpy(check_partition_descriptor, partition_descriptor, p*ANONYMOUSLIB_CSR5_OMEGA*num_packet * sizef(ANONYMOUSLIB_UIT), cudaMemcpyDeviceToHost));
...
//    cudaMemcpy(check_column_index, column_index, nnz * sizeof(ANONYMOUSLIB_IT), cudaMemcpyDeviceToHost);
...
//    cudaMemcpy(check_value, value, nnz * sizeof(ANONYMOUSLIB_VT), cudaMemcpyDeviceToHost);
